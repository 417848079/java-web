            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="signin-form">
                        <form action="/loginServlet" method="post" name="formData">
                            <div class="form-group">
                                <label for="signin_form">user</label>
                                <input type="email" class="form-control" name="username" id="signin_form" placeholder="enter your email here">
                            </div><!--/.form-group -->
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="signin-footer">
                        <button type="button"  class="btn signin_btn" data-toggle="modal" onclick="submitFun(document.formData)">
                            sign in
                        </button>
                        <p>
